          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm space-y-6">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  AI-simulated advancement model detailing future corporate roles and transitions.
                </p>
              </div>
              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="relative flex justify-between items-center bg-gray-50 p-4 rounded-xl border border-gray-200">
                  ...
                  {careerProgression.predictedRoles.map((role: PredictedRole, idx: number) => {
                ...
                {careerProgression.predictedRoles[selectedPredictedRoleIdx] && (() => {
                  const activeRole = careerProgression.predictedRoles[selectedPredictedRoleIdx];
                  return (
